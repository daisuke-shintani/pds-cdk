...
interface RiyotsuchiApiGwKdsStackProps extends StackProps, commonConstruct, ritsurikakuConstruct {}

// API GW - Lambda構成
export class RiyotsuchiApiGwKdsStack extends Stack {
  constructor(scope: Construct, id: string, props: RiyotsuchiApiGwKdsStackProps) {
    super(scope, id, props)
    Tags.of(this).add('projectName', 'riyotsuchi')

    // DataStreams-----------------------------------------------------------------------
    const kdsStream = new KdsDataStream(this, 'riyotsuchiDataStream', {
      prefix: props.prefix,
    ...
    // PrivateApiGw----------------------------------------------------------------------
    const privateApi = new KdsPrivateApitGw(this, 'riyotsuchiApiGW', {
      // APIGWと統合するデータストリーム
    ...
    // Dashboard----------------------------------------------------------------------------
    new KdsDashboard(this, 'riyotsuchiDashboard', {
      //  restAPI
